...
function applyDefaultProps(instance, oldProps, newProps) {
  ...
  for (var _i2 = 0; _i2 < props.length; _i2++) {
    ...
    } else if (!lodash_isnil(instance[prop]) && prop in PROPS_DISPLAY_OBJECT) {
...
var AnimatedSprite = function AnimatedSprite(root, props) {
  ...
  animatedSprite.applyProps = function (instance, oldProps, newProps) {
    var textures = newProps.textures,
        ...
        props = _objectWithoutProperties(newProps, ["textures", "isPlaying", "initialFrame"]);
...
var scheduler_1 = scheduler.unstable_scheduleCallback;
var scheduler_2 = scheduler.unstable_cancelCallback;
...
var aa=objectAssign,ba=React__default,m=scheduler;function n(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return "Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var p=ba.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
...
function insertBefore(parent, child, beforeChild) {
  invariant_1(child !== beforeChild, 'react-pixi: PixiFiber cannot insert node before itself');
...
var hostconfig = {
  ...
  createTextInstance: function createTextInstance(text, rootContainerInstance, internalInstanceHandler) {
    invariant_1(false, 'react-pixi: PixiFiber does not support text nodes as children of a Pixi component. To pass a string value to your component, use a property other than children. If you wish to display some text, you can use <Text text={string} /> instead.');
  },
...
var withPixiApp = function withPixiApp(BaseComponent) {
  var wrapper = React__default.forwardRef(function (props, ref) {
    return /*#__PURE__*/React__default.createElement(AppConsumer, null, function (app) {
      return /*#__PURE__*/React__default.createElement(BaseComponent, _extends({}, props, {
        ref: ref,
        app: app
      }));
    });
...
var Stage = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Stage, [{
    ...
    value: function getChildren() {
      ...
      return /*#__PURE__*/React__default.createElement(AppProvider, {
        value: this.app
      }, children);
    }
  }, {
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement("canvas", _extends({}, getCanvasProps(this.props), {
        ref: function ref(c) {
...
var withFilters = function withFilters(WrapperComponent, filters) {
  invariant_1(_typeof(filters) === 'object', 'Second argument needs to be an indexed object with { prop: Filter }');
  ...
  var Wrapper = function Wrapper(_ref) {
    ...
    return /*#__PURE__*/React__default.createElement(WrapperComponent, _extends({}, restProps, {
